...
public class DefaultResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter methodParameter, Class<? extends HttpMessageConverter<?>> clazz) {
        return true;    // 注意这里要返回 true, 不能是默认的 false
    }

    @Override
    public Object beforeBodyWrite(Object o, MethodParameter methodParameter, MediaType mediaType, Class<? extends HttpMessageConverter<?>> clazz,
